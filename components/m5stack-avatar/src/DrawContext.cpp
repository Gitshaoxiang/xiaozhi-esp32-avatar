...
Gaze DrawContext::getLeftGaze() const {
    return leftGaze;
}

float DrawContext::getLeftEyeOpenRatio() const {
    return leftEyeOpenRatio;
}

Gaze DrawContext::getRightGaze() const {
    return rightGaze;
}

float DrawContext::getRightEyeOpenRatio() const {
    return rightEyeOpenRatio;
}
...
float DrawContext::getRotation() const {
    return rotation;
}

float DrawContext::getScale() const {
    return scale;
}

String DrawContext::getspeechText() const {
    return speechText;
}

ColorPalette* const DrawContext::getColorPalette() const {
    return palette;
}

int DrawContext::getColorDepth() const {
    return colorDepth;
}

const lgfx::IFont* DrawContext::getSpeechFont() const {
    return speechFont;
}
...
int32_t DrawContext::getBatteryLevel() const {
    return batteryLevel;
}
