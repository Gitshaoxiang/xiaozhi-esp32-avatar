...
class Pi4ioe : public I2cDevice {
   public:
    Pi4ioe(i2c_master_bus_handle_t i2c_bus, uint8_t addr)
...
class Lp5562 : public I2cDevice {
   public:
    Lp5562(i2c_master_bus_handle_t i2c_bus, uint8_t addr)
        ...
        WriteReg(0x70, 0B00000000);  // Configure all LED outputs to be
   ...
   private:
    ...
    void InitializeGc9107Display() {
        ...
        panel_config.bits_per_pixel =
            16;  // Implemented by LCD command `3Ah` (16/18)
   ...
   public:
    ...
    virtual AudioCodec* GetAudioCodec() override {
        static Es8311AudioCodec audio_codec(
            i2c_bus_, I2C_NUM_1, AUDIO_INPUT_SAMPLE_RATE,
